        ...
        <footer className="bg-white text-green-900 p-8 font-Rubik text-center">
            <div className="container mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 shadow-sm pr-10 pl-10 p-4">
                ...
                <div className="mb-6">
                    ...
                    <p className="text-violet-900 font-semibold mb-2">19th Stone</p>
                    <p className="text-violet-900 font-semibold mb-2">ABES Engineering College,Ghaziabad</p>
                    <p className="text-violet-900 font-semibold mb-2">Email: iabhishek@gmail.com</p>
                    <p className="text-violet-900 font-semibold">Phone: (+91)9315014084</p>
                </div>
